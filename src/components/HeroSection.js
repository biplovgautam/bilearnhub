          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-lg">
              <LottiePlayer
                ...
                fallback={
                  <div className="h-[500px] w-full bg-background border border-secondary/30 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <svg className="h-24 w-24 mx-auto mb-4 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
